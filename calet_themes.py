...
class LightTheme:
    ...
    def __init__(self, transparent = None, 
            transparent_05 = None, transparent_1 = None, transparent_2 = None, 
            transparent_3 = None, transparent_5 = None, transparent_8 = None,
            transparent_inverse_4 = None, transparent_inverse_8 = None,
            background_one = None, background_two = None, divider = None,
            font_one = None, font_two = None, font_three = None, font_four = None,
            primary = None, primary_block = None, primary_hovered = None,
            secondary = None, secondary_block = None,
            tonal = None, tonal_block = None,
        ...
        self.transparent_2 = ft.colors.with_opacity(0.2, "black") if transparent_2 is None else transparent_2
        ...
        self.transparent_inverse_4 = ft.colors.with_opacity(0.8, "white") if transparent_inverse_4 is None else transparent_inverse_4
        self.transparent_inverse_8 = ft.colors.with_opacity(0.8, "white") if transparent_inverse_8 is None else transparent_inverse_8 
        # basic colors
        ...
        self.font_four = "white" if font_four is None else font_four
        # special text colors
        ...
        self.primary_hovered = "blue300" if primary_hovered is None else primary_hovered
        ...
        self.tonal = self.primary if tonal is None else tonal
        self.tonal_block = self.primary_block if tonal_block is None else tonal_block
        ...
        self.accept = "green" if accept is None else accept
        self.accept_hovered = "green400" if accept_hovered is None else accept_hovered
        ...
        self.cancel = "red" if cancel is None else cancel
        self.cancel_hovered = "red400" if cancel_hovered is None else cancel_hovered
...
class DarkTheme:
    ...
    def __init__(self, transparent = None, 
        ...
        self.transparent_2 = ft.colors.with_opacity(0.2, "white") if transparent_2 is None else transparent_2
        ...
        self.transparent_inverse_4 = ft.colors.with_opacity(0.4, "black") if transparent_inverse_4 is None else transparent_inverse_4 
        self.transparent_inverse_8 = ft.colors.with_opacity(0.8, "black") if transparent_inverse_8 is None else transparent_inverse_8 
        # general colors
        ...
        self.font_four = "black" if font_four is None else font_four
        # special colors
        self.primary = "blue" if primary is None else primary
        self.primary_block = ft.colors.with_opacity(0.2, self.primary) if primary_block is None else primary_block
        self.primary_hovered = "blue300" if primary_hovered is None else primary_hovered
        ...
        self.success_block = ft.colors.with_opacity(0.2, self.success) if success_block is None else success_block
        self.accept = "green" if accept is None else accept
        self.accept_hovered = "green300" if accept_hovered is None else accept_hovered
        self.error = "red" if error is None else error
        self.error_block = ft.colors.with_opacity(0.2, self.error) if error_block is None else error_block
        self.cancel = "red" if cancel is None else cancel
        self.cancel_hovered = "red300" if cancel_hovered is None else cancel_hovered
        self.warning = "yellow" if warning is None else warning
        self.warning_block = ft.colors.with_opacity(0.2, self.warning) if warning_block is None else warning_block

class Theme:
    
    def __init__(self, on_light:LightTheme=None, on_dark:DarkTheme=None, mode='light'):
        """It's a colors theme to be used in all Calet components.\n
        ---
        - ```on_light```: an instance of ```calet_themes.LightTheme``` containing the colors set that will be used
                        when the ```Theme``` object is in light mode.
        - ```on_dark```: an instance of ```DarkTheme``` containing the colors set that will be used
                        when the ```Theme``` object is in dark mode.
        - ```mode```: an string saying in which mode is the theme. Can be 'light' for light mode
                or 'dark' for dark mode. If ```on_dark``` is not given, defaults to 'light' mode, even if ```mode``` 
                value is 'dark'. If ```on_light``` is also not given, defaults to predetermined light theme.
        """
        self.on_light = on_light if on_light is not None else LightTheme()
    ...
    def to_light(self):
        ...
        self.transparent_2 = self.on_light.transparent_2
        ...
        self.transparent_inverse_4 = self.on_light.transparent_inverse_4
        self.transparent_inverse_8 = self.on_light.transparent_inverse_8
        # general colors
    ...
    def to_dark(self):
        ...
        self.transparent_2 = self.on_dark.transparent_2
        ...
        self.transparent_inverse_4 = self.on_dark.transparent_inverse_4
        self.transparent_inverse_8 = self.on_dark.transparent_inverse_8
        # general colors
    ...
    def upd(self, on_light:LightTheme=None, on_dark:DarkTheme=None, mode:str=None):
