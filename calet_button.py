...
if __name__ == "__main__":
    ...
    def main(page: ft.Page):
        ...
        b_textselectable = ClSelectableTextButton(
            theme=theme,
        ...
        b_selectable = ClSelectableButton(
            theme=theme,
            text="Selectable",
            icon=ft.icons.PEOPLE_OUTLINED,
            hover_icon=ft.icons.PEOPLE,
        ...
        b_crystalselectable = ClSelectableCrystalButton(
            theme=theme,
            text="Crystal selectable",
            icon=ft.icons.PEOPLE_OUTLINED,
            hover_icon=ft.icons.PEOPLE,
            # selected=True
        )
        ...
        b_crystalfilter = ClCrystalFilterButton(
            theme=theme,
            text="Crystal filter",
            selected=True,
            # rounded=False
        )
        b_removable_filter = ClRemovableFilter(
            theme=theme,
            text="Removable filter",
            # rounded=False
        )
        b_removable_crystalfilter = ClRemovableCrystalFilter(
            theme=theme,
            text="Removable crystal filter",
            # rounded=False
        )
        b_nav = ClNavButton(
            expand=1,
                ...
                content=ft.Column(
                    ...
                    controls=[
                        ...
                        ft.Container(
                            ...
                            content=ft.Row(
                                spacing=20,
                                controls=[b_filter, b_crystalfilter, b_removable_filter, b_removable_crystalfilter]
                            )
                        ),
                        ft.Container(
                            expand=7,
                            ...
                            content=ft.Column(
                                ...
                                controls=[
                                    ft.Row(
                                        expand=1,
                                        spacing=20, 
                                        controls=[b_text, b_normal, b_outlined, b_accept, b_cancel, b_tonal, b_menu]
                                    ),
                                    ft.Row(
                                        expand=1,
                                        spacing=20, 
                                        controls=[b_textselectable, b_selectable, b_crystalselectable, b_mode, b_icon, b_color]
                                    ),
                                    ft.Row(
                                        expand=1,
                                        spacing=20, 
                                    ...
                                    ft.Container(
                                        ...
                                        content=ft.Row(
                                            expand=1,
                                            spacing=0, 
                                            controls=[b_navtab1, b_navtab2, b_navtab3, b_tonal2]
                                        ),
                                    ),
                                    ft.Container(
                                        expand=1,
